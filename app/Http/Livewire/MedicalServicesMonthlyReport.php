...
class MedicalServicesMonthlyReport extends Component
{
    public $month, $year;
    ...
    {
        return view('livewire.medical-services-monthly-report', [
    ...
    public function export($ext)
    {
        ...
        return Excel::download(new MedicineMonthlyExport($this->report, $this->designations, $this->totalCountPerDesignation, $this->totalCount, $this->month, $this->year), 'monthly-medicine-report.' .$ext);
    }
}

...
use App\Exports\MedicalIllnessMonthlyExport;
...
class MedicalIllnessMonthlyReport extends Component
{
    public $month, $year;
    ...
    {
        return view('livewire.medical-illness-monthly-report', [
    ...
    public function export($ext)
    {
        ...
        return Excel::download(new MedicalIllnessMonthlyExport($this->report, $this->designations, $this->totalCountPerDesignation, $this->totalCount, $this->month, $this->year), 'monthly-medical-illness-report.' .$ext);
    }
}

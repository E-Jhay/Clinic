...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <h1>Expired Medicine Quarterly Reports</h1>
        <div class="d-flex">
          ...
          <div class="btn-group float-right">
            ...
            <a class="text-white" href="{{route('expired-medicine-monthly-report')}}">Monthly</a>
            </button>
            <button class="btn btn-primary active">
            <a class="text-white" href="{{route('expired-medicine-quarterly-report')}}">Quarterly</a>
            </button>
            <button class="btn btn-primary">
            <a class="text-white" href="{{route('expired-medicine-anually-report')}}">Anually</a>
            </button>
          </div>
        </div>
        <div class="input-group mt-2">
              ...
              <div class="col-12 table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2"><strong>Total No. of Medicine Expired</strong></td>

                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-warning btn-sm" wire:click="editEquipment('{{$equipment->id}}')"><i class="fas fa-edit"></i> Edit</button>
                                                        <button class="btn btn-success btn-sm" wire:click="addStock({{$equipment->id}})"><i class="fas fa-eye"></i> Add Stock</button>
                                                        <button class="btn btn-danger btn-sm" wire:click="removeStock({{$equipment->id}})"><i class="fas fa-eye"></i> Remove Stock</button>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
